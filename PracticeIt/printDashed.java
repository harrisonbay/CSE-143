/* Write a recursive method called printDashed that takes an integer as a 
parameter and that prints the integer with dashes in between the digits. 
...
construct any structured objects (no array, ArrayList, String, StringBuilder, 
